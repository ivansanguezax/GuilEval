...
import {
  SpinnerIcon
} from "./chunk-GH2A6KCL.js";
import {
  CSSTransition,
  TimesIcon
} from "./chunk-V6ZLQYCO.js";
import {
  IconBase,
  Ripple
} from "./chunk-P4T3GRV6.js";
import {
  Tooltip
} from "./chunk-RLZKCYUU.js";
import {
  ComponentBase,
  DomHandler,
  EventBus,
...
var DropdownItem = React5.memo(function(props) {
  ...
  return React5.createElement("li", itemProps, checkmark && iconRenderer(), React5.createElement("span", itemGroupLabelProps, content), React5.createElement(Ripple, null));
});
...
var Dropdown = React5.memo(React5.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React5.useState(""), _React$useState2 = _slicedToArray2(_React$useState, 2), filterState = _React$useState2[0], setFilterState = _React$useState2[1];
  var _React$useState3 = React5.useState(false), _React$useState4 = _slicedToArray2(_React$useState3, 2), focusedState = _React$useState4[0], setFocusedState = _React$useState4[1];
  var _React$useState5 = React5.useState(-1), _React$useState6 = _slicedToArray2(_React$useState5, 2), focusedOptionIndex = _React$useState6[0], setFocusedOptionIndex = _React$useState6[1];
  var _React$useState7 = React5.useState(false), _React$useState8 = _slicedToArray2(_React$useState7, 2), overlayVisibleState = _React$useState8[0], setOverlayVisibleState = _React$useState8[1];
  ...
  var createDropdownIcon = function createDropdownIcon2() {
    ...
    var icon = props.dropdownIcon || React5.createElement(ChevronDownIcon, dropdownIconProps);
